...
export default function homeUser() {
    ...
    pSection.textContent =
        "Aqui, no nosso acervo, você encontrará informações diversas sobre as mais diferentes criaturas. Informações trazidas por pesquisadores oficializados de forma resumida e de facil entendimento!";

    const pSection2 = document.createElement("p");
    pSection2.classList.add("bodyText");
    pSection2.textContent =
        "Você, pesquisador, tambem pode fazer parte do nosso grupo, entre em ";
